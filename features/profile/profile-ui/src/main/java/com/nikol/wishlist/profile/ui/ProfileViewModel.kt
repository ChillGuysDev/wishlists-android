...
import com.nikol.wishlist.core.ui.models.toDomain
import com.nikol.wishlist.core.ui.models.toUi
import com.nikol.wishlist.core.utils.copyFileFromUri
...
interface ProfileAuthListener {
    ...
    fun onAddWishlistItemClick(wishlistId: Long, item: WishlistItemInput)
...
class ProfileViewModel @Inject constructor(
    ...
    override fun onAddWishlistItemClick(wishlistId: Long, item: WishlistItemInput) {
        viewModelScope.launch {
